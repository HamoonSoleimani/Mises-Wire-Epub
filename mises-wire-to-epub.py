...
IGNORED_IMAGE_URLS = {
    ...
    # Add patterns for problematic featured images from podcast and section pages
    ...
    def fetch_page_links(page_num):
        ...
        try:
            with get_session() as session:
                response = session.get(page_url, timeout=TIMEOUT, verify=VERIFY)
...
def main():
    global PROXIES, VERIFY, TIMEOUT
    parser = argparse.ArgumentParser(description='Convert Mises Wire articles into EPUB files with enhanced image handling.')
